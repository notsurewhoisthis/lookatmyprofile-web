...
export default function VsCleveAIPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <section className="container mx-auto px-4 py-16 border-t border-gray-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center">Compare With Other Platforms</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/vs-olly-social" className="text-center p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
              <h3 className="font-semibold mb-1">vs Olly Social</h3>
              <p className="text-sm text-gray-400">Customizable roasts comparison</p>
            </Link>
            <Link href="/vs-roast-master" className="text-center p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
              <h3 className="font-semibold mb-1">vs Roast Master</h3>
              <p className="text-sm text-gray-400">Classic roaster showdown</p>
            </Link>
            <Link href="/ai-roast-generator" className="text-center p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
              <h3 className="font-semibold mb-1">Our AI Generator</h3>
