...
export default function BillingSuccessPage() {
  ...
  return (
    <Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white grid place-items-center px-4">Loading…</div>}><div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white grid place-items-center px-4">
